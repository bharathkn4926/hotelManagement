...
public class GuestDetailsInfo {
	...
	public GuestDetailsInfo(int guestId, String guestName, String guestPhoneNumber, String guestEmailId,
			String guestIdentityCardType, String guestIdentityCardNumber, String guestAddress, int guestNumberOfPeople,
			String requiredRoomType, int guestRoomNumber, double guestTotalAmount, double guestAdvancePaid) {
		super();
